            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Input Kritik & Saran</li>
                    </ol>
                </section>
...
if(isset($_POST['input'])){
    ...
    $cekno= mysqli_query($koneksi, "SELECT * FROM pesan ORDER BY id_pesan DESC");
        ...
        echo "<script>alert('Pesan berhasil dimasukan!'); window.location = 'pesan.php'</script>";	   
		}
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Input Pesan</h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-pesan.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">ID Pesan</label>
                            <div class="col-sm-8">
                            <input name="id_pesan" type="text" id="id_pesan" class="form-control" autocomplete="off" placeholder="Auto Number Tidak perlu di isi" readonly="readonly"/>
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Nama</label>
                            <div class="col-sm-3">
                            <input name="nama" type="text" id="nama" class="form-control" autocomplete="off" placeholder="Nama Customer" autocomplete="off" required="required" /> 
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">No Telepon</label>
                            <div class="col-sm-3">
                            <input name="no_telp" type="text" id="no_telp" class="form-control" autocomplete="off" placeholder="No Telepon" autocomplete="off" required="required" />  
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Pesan</label>
                            <div class="col-sm-3">
                            <input name="pesan" type="text" id="pesan" class="form-control" autocomplete="off" placeholder="Kritik & Saran" autocomplete="off" required="required" /> 
                            </div>
                          </div>
                  </div>
                          <div class="form-group">

...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
           ...
           <!-- /.row -->
                    ...
                    <?php
                    $query = mysqli_query($koneksi, "SELECT * FROM booking WHERE id_booking='$_GET[id_booking]'");
                    ...
                    <td width="550"><?php echo $data['no_telp']; ?></td>
                    </tr>
					<tr>
                    <td width="250">No Plat</td>
                    <td width="550"><?php echo $data['no_plat']; ?></td>
                    </tr>
                   </table>

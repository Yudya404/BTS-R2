        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
					...
					<td>
					<input type='date' class="form-control" style="margin-bottom: 4px;" name='keyword' id="keyword" placeholder='Cari Data Berdasarkan Tanggal' required />
           ...
           <!-- /.row -->
					...
					<div class="text-right">
						<a href="cetak.php" class="btn btn-sm btn-success">Cetak Laporan<i class="fa fa-arrow-circle-right"></i></a>
					</div>
					<br />
                   ...
                   <?php
					...
					$sql =  "SELECT * FROM booking WHERE tgl_booking between '$tgl_awal' and '$tgl_akhir'";
					...
					<a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Cetak Laporan" href="cetak.php?hal=cetak&id_booking=<?php echo $data['id_booking'];?>"><span class="glyphicon glyphicon-print"></span></a></div>
					<?php
                        $i++; 
                        $count++;
                        }

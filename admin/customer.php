...
<html>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
	       ...
	       <input type='text' class="form-control" style="margin-bottom: 4px;" name='keyword' placeholder='Nama & Nopol' required /> 
           ...
           <!-- /.row -->
					...
					$sql =  "SELECT * FROM booking WHERE nama LIKE '%$keyword%' or no_plat like '%$keyword%'";
                  ...
                  <thead>
                      <tr>
						...
						<th><center>ID Booking</i></center></th>
						<th><center>Nama</i></center></th>
                        <th><center>No Telp</i></center></th>
						<th><center>No Plat</i></center></th>
                      </tr>
                  </thead>
                     <?php
                    ...
                    <td><center><?php echo $data['id_booking'];?></td>
                    <td><span class="glyphicon glyphicon-user"></span><?php echo $data['nama'];?></td>

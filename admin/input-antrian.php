    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
				...
				echo "<script>alert('Data Antrian berhasil dimasukan!'); window.location = 'antrian.php'</script>";	   
				}
				?>
           <!-- /.row -->
                    <br />
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-retweet"></i> Input Data Antrian</h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-antrian.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
						 ...
						 <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">No Antrian</label>
                              <div class="col-sm-8">
                                  <input name="no_antrian" type="text" id="no_antrian" class="form-control" autocomplete="off" placeholder="Isi Sesuai Urutan" required="required"/>
                              </div>
                         </div>
						 <div class="form-group">

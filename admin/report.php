            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Laporan Data Booking</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <div class="row"> 
					<div class="col-lg-4">
					<form action='print.php' method="POST" name="cari">
					<td>
					<!--<input type='date' class="form-control" style="margin-bottom: 4px;" name='tgl_awal' id="tgl_awal" placeholder='Cari Data Dari Tanggal' required />
					<input type='date' class="form-control" style="margin-bottom: 4px;" name='tgl_akhir' id="tgl_akhir" placeholder='Cari Data Sampai Tanggal' required />
					<input type='submit' value='Cari Data' name="cari" class="btn btn-sm btn-primary" /> <a href='report.php' class="btn btn-sm btn-success" >Refresh</i></a>-->
					</div>
					</div>
					<!-- /.row -->
                    <br />
                    ...
                    <div class="row">
                        <div class="col-lg-12">
				  <div class="text-left">
                  <a href="index.php" class="btn btn-sm btn-warning">Kembali<i class="fa fa-arrow-circle-left"></i></a>
				  </div>
				  ...
				  <td>
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="submit" name="cari" value="Cetak" class="btn btn-sm btn-primary" />&nbsp;
	                          <a href="report.php" class="btn btn-sm btn-danger">Batal </a>
                            </div>
                          </div>
                     </form>
					 </form>
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-book"></i> Laporan Data Booking</h3> 
                        </div>
                        <div class="panel-body">
                   ...
                   $batas = 5;
					...
					<td><center><?php echo $data['status_antrian'];?></center></td>
                    <!--<td><center><div id="thanks">
					<a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Cetak Laporan" href="tiket.php?hal=cetak&id_booking=<?php echo $data['id_booking'];?>">

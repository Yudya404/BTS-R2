...
<script src="responsive-calendar/js/responsive-calendar.js"></script>
    ...
    <body class="skin-black">
		...
		if($hb > 3){
			...
			echo "<div class='alert alert-danger'>Nopol Anda sudah dipesan untuk tanggal tersebut.</div>";
		}
		else{
		
		$sql = "INSERT INTO booking (nama, no_telp,no_plat,tipe, jenis, estimasi_biaya, tgl_booking, catatan, status_antrian) 
		VALUES ('".$nama."' ,'".$no_telp."','".$no_plat."','".$tipe."', '".$servis."', '".$estimasi_biaya."', '".$tgl_booking."', '".$catatan."', '".$status_antrian."' )";
...
?>
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Tambah Data Booking</h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-booking.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Id Booking</label>
                              <div class="col-sm-8">
                                  <input name="id_booking" type="text" id="id_booking" class="form-control" autocomplete="off" placeholder="Auto Number Tidak perlu di isi" readonly="readonly"/>
                              </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Nama </label>
                              <div class="col-sm-3">
								<input name="nama" type="text" id="nama" class="form-control" autocomplete="off" placeholder="Nama" autocomplete="off" required="required" />
							  </div>
                          </div>
						  <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">No Telp </label>
                              <div class="col-sm-3">
								<input name="no_telp" type="text" id="no_telp" class="form-control" autocomplete="off" placeholder="No Telp" autocomplete="off" required="required" />
							  </div>
                          </div>
						  <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Nopol </label>
                              <div class="col-sm-3">
								<input name="no_plat" type="text" id="no_plat" class="form-control" autocomplete="off" placeholder="No Plat" autocomplete="off" required="required" />
							  </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Tipe Motor</label>
							    <div class="col-sm-3">
									<select id="tipe" name="tipe" class="form-control" required="required">
						  ...
						  <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label" for="datepicker">Tanggal Booking </label>
                              <div class="col-sm-3">
								<input type="text" id="datepicker" name="tgl_booking" class="form-control" autocomplete="off" placeholder="Tanggal Booking" autocomplete="off" required="required" />
							  </div>
                          </div>
						  <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Estimasi Biaya </label>
                              <div class="col-sm-3">
								<span type="text" name="payment-total" id="payment-total" class="form-control" autocomplete="off" placeholder="Estimasi Biaya" autocomplete="off" required="required" />0</span>
							  </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Catatan </label>
                              <div class="col-sm-3">
								<input name="catatan" type="text" id="catatan" class="form-control" autocomplete="off" placeholder="Servis Tambahan" autocomplete="off" required="required" />
							  </div>
                          </div>
						  <div class="form-group">
						  ...
						  <div class="form-group">
                             <label class="col-sm-2 col-sm-2 control-label"></label>
                              <div class="col-sm-10">
								...
								<a href="booking.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
								</div>
                          </div>
                      </form>
                  </div>
